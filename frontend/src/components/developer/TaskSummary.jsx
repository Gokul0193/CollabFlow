...
import { CheckCircle2, Circle, Clock, CheckSquare, Eye, AlertTriangle } from "lucide-react";

const TaskSummary = ({ tasks = [], onUpdateStatus }) => {
  // Production default developer tasks if none exist in DB
  const defaultTasks = [
    {
      id: "task-1",
  ...
  // Filter tasks into Trello's exact 4 columns
  ...
  // Cycle through Trello columns dynamically on click
  ...
  // Helper: map priority to glow colors
